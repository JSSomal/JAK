...
public class ByPartialLinkText extends InitializeDriver implements DriverActions {
	...
	public void click(String selector, String actionInfo) {
		...
		try {
			...
			WebElement element = driver.findElement(By.partialLinkText(selector));
	...
	public int getSize(String selector, String actionInfo) {
		...
		try {
			...
			/*WebElement element = driver.findElement(By.partialLinkText(selector));
			 */
			List<WebElement> options = driver.findElements(By.partialLinkText(selector));
	...
	public List<WebElement> getElements(String selector, String actionInfo) {
		...
		try {
			...
			elementList = driver.findElements(By.partialLinkText(selector));
