...
public class DBManager  {
	...
	public static Connection openDBConnection_Mssql(String hostUserPswd) 
		...
		//String Url = ReadDataFromPropertiesFile.testReadDataFromPropertiesFile_saasData("conString");
		...
		// "jdbc:sqlserver://10.8.18.112:1450;user=server1;password=mind@123;database=ApexSuperAdminDB");
		//
